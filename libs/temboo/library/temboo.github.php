...
class GitHub_ReposAPI_Commits_ListCommits_Inputs extends Temboo_Inputs
{
   /**
    ...
    /**
     * Set the value for the Author input for this ListCommits Choreo.
     *
     * @param string $value (optional, string) GitHub login or email address by which to filter by commit author.
     * @return GitHub_ReposAPI_Commits_ListCommits_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Since input for this ListCommits Choreo.
     *
     * @param string $value (optional, date) Only commits after this date will be returned. This is a timestamp in ISO 8601 format: YYYY-MM-DDTHH:MM:SSZ.
     * @return GitHub_ReposAPI_Commits_ListCommits_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Until input for this ListCommits Choreo.
     *
     * @param string $value (optional, date) Only commits before this date will be returned. This is a timestamp in ISO 8601 format: YYYY-MM-DDTHH:MM:SSZ.
     * @return GitHub_ReposAPI_Commits_ListCommits_Inputs For method chaining.
     */
