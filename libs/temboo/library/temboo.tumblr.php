...
class Tumblr_Post_CreateAudioPostWithURL_Inputs extends Temboo_Inputs
{
   /**
     ...
     *
     * @param string $value (optional, string) Manages the autotweet (if enabled) for this post. Set to "off" for no tweet. Enter text to override the default tweet.
     * @return Tumblr_Post_CreateAudioPostWithURL_Inputs For method chaining.
     */
 ...
 * @subpackage Tumblr
 */
class Tumblr_Tagged_RetrievePostsWithTag extends Temboo_Choreography
{
    /**
     * Retrieves posts that have a given tag.
     *
     * @param Temboo_Session $session The session that owns this RetrievePostsWithTag Choreo.
     * @return Tumblr_Tagged_RetrievePostsWithTag New instance.
     */
    public function __construct(Temboo_Session $session)
    {
        parent::__construct($session, '/Library/Tumblr/Tagged/RetrievePostsWithTag/');
    }

    /**
     * Executes this Choreo.
     *
     * Execution object provides access to results appropriate for this RetrievePostsWithTag Choreo.
     *
     * @param Tumblr_Tagged_RetrievePostsWithTag_Inputs|array $inputs (optional) Inputs as Tumblr_Tagged_RetrievePostsWithTag_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
     * @return Tumblr_Tagged_RetrievePostsWithTag_Execution New execution object.
     * @throws Temboo_Exception_Authentication if session authentication fails.
     * @throws Temboo_Exception_Execution if runtime errors occur in synchronous execution or execution fails to start. NOT thrown for post-launch errors in asynchronous execution -- check status or results to determine asynchronous success.
     * @throws Temboo_Exception_Notfound if choreography does not exist.
     * @throws Temboo_Exception if execution request fails.
    ...
    public function execute($inputs = array(), $async = false, $store_results = true)
    {
        return new Tumblr_Tagged_RetrievePostsWithTag_Execution($this->session, $this, $inputs, $async, $store_results);
    }

    /**
     * Obtains a new inputs object.
     *
     * Includes setters appropriate for this RetrievePostsWithTag Choreo.
     *
     * @param array $inputs (optional) Associative array of input names and values.
     * @return Tumblr_Tagged_RetrievePostsWithTag_Inputs New inputs object.
     * @throws Temboo_Exception if provided input set is invalid. (Note an empty set is considered valid.)
     */
    public function newInputs($inputs = array())
    {
        return new Tumblr_Tagged_RetrievePostsWithTag_Inputs($inputs);
    }
}


/**
 * Inputs object with appropriate setters for the RetrievePostsWithTag Choreo.
 *
 * @package Temboo
 * @subpackage Tumblr
 */
class Tumblr_Tagged_RetrievePostsWithTag_Inputs extends Temboo_Inputs
{
   /**
     * Inputs object with appropriate setters for the RetrievePostsWithTag Choreo.
     *
     * @param array $inputs (optional) Associative array of input names and values.
     * @return Tumblr_Tagged_RetrievePostsWithTag_Inputs New instance.
     * @throws Temboo_Exception if provided input set is invalid. (Note an empty set is considered valid.)
     */
    public function __construct($inputs = array())
    {
    ...
    /**
     * Set arbitrary input this RetrievePostsWithTag input set.
     *
     * Input names are case sensitive.
     *
     * @param string $name Input name.
     * @param string $value Input value.
     * @return Tumblr_Tagged_RetrievePostsWithTag_Inputs For method chaining.
     */
    public function set($name, $value)
    {
        return parent::set($name, $value);
    ...
    /**
     * Set the value for the APIKey input for this RetrievePostsWithTag Choreo.
     *
     * @param string $value (required, string) The API Key provided by Tumblr (AKA the OAuth Consumer Key).
     * @return Tumblr_Tagged_RetrievePostsWithTag_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Before input for this RetrievePostsWithTag Choreo.
     *
     * @param string $value (optional, string) The timestamp of when you'd like to see posts before (e.g. 1363716547).
     * @return Tumblr_Tagged_RetrievePostsWithTag_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Filter input for this RetrievePostsWithTag Choreo.
     *
     * @param string $value (optional, string) Specifies the post format to return. Valid values are: text (plain text, no html) or raw (as entered by the user).
     * @return Tumblr_Tagged_RetrievePostsWithTag_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Limit input for this RetrievePostsWithTag Choreo.
     *
    ...
    /**
     * Set the value for the Offset input for this RetrievePostsWithTag Choreo.
     *
    ...
    /**
     * Set the value for the ResponseFormat input for this RetrievePostsWithTag Choreo.
     *
     * @param string $value (optional, string) The format that the response should be in. Can be set to xml or json. Defaults to json.
     * @return Tumblr_Tagged_RetrievePostsWithTag_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the Tag input for this RetrievePostsWithTag Choreo.
     *
     * @param string $value (required, string) The tag on the posts you'd like to retrieve.
     * @return Tumblr_Tagged_RetrievePostsWithTag_Inputs For method chaining.
     */
...
/**
 * Execution object for the RetrievePostsWithTag Choreo.
 *
 * @package Temboo
 * @subpackage Tumblr
 */
class Tumblr_Tagged_RetrievePostsWithTag_Execution extends Temboo_Choreography_Execution
{
    /**
     * Execution object for the RetrievePostsWithTag Choreo.
     *
     * @param Temboo_Session $session The session that owns this RetrievePostsWithTag execution.
     * @param Tumblr_Tagged_RetrievePostsWithTag $choreo The choreography object for this execution.
     * @param Tumblr_Tagged_RetrievePostsWithTag_Inputs|array $inputs (optional) Inputs as Tumblr_Tagged_RetrievePostsWithTag_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
     * @return Tumblr_Tagged_RetrievePostsWithTag_Execution New execution.
     * @throws Temboo_Exception_Authentication if session authentication fails.
     * @throws Temboo_Exception_Execution if runtime errors occur in synchronous execution or execution fails to start. NOT thrown for post-launch errors in asynchronous execution -- check status or results to determine asynchronous success.
     * @throws Temboo_Exception_Notfound if choreography does not exist.
     */
    public function __construct(Temboo_Session $session, Tumblr_Tagged_RetrievePostsWithTag $choreo, $inputs = array(), $async = false, $store_results = true)
    {
        parent::__construct($session, $choreo, $inputs, $async, $store_results);
    }
     ...
     * Obtains a new results object.
     *
     * Includes getters appropriate for this RetrievePostsWithTag execution.
     *
     * @return Tumblr_Tagged_RetrievePostsWithTag_Results New results object.
     * @throws Temboo_Exception_Authentication if session authentication fails.
     * @throws Temboo_Exception_Execution if runtime errors occurred in asynchronous execution.
     * @throws Temboo_Exception_Notfound if execution does not exist.
     * @throws Temboo_Exception if result request fails.
    ...
    /**
     * Wraps results in appropriate results class for this RetrievePostsWithTag execution.
     *
     * @param array $outputs Associative array of output names and values.
     * @return Tumblr_Tagged_RetrievePostsWithTag_Results New results object.
     */
    protected function wrapResults($outputs)
    {
        return new Tumblr_Tagged_RetrievePostsWithTag_Results($outputs);
    }
}


/**
 * Results object with appropriate getters for the RetrievePostsWithTag Choreo.
 *
 * @package Temboo
 * @subpackage Tumblr
 */
class Tumblr_Tagged_RetrievePostsWithTag_Results extends Temboo_Results
{
    /**
     * Results object with appropriate getters for the RetrievePostsWithTag Choreo.
     *
     * @param array $outputs (optional) Associative array of output names and values.
     * @return Tumblr_Tagged_RetrievePostsWithTag_Results New instance.
     * @throws Temboo_Exception if provided output set is invalid. (Note an empty set is considered valid.)
     */
    public function __construct($outputs = array())
    {
    ...
    /**
     * Retrieve the value for the "Response" output from this RetrievePostsWithTag execution.
     *
     * @return string The response from Tumblr. Default is JSON, can be set to XML by entering 'xml' in ResponseFormat.
     * @throws Temboo_Exception_Notfound if output does not exist. (Note an empty response is considered valid.)
     */
