...
class DataGov_GetCensusIDByCoordinates_Inputs extends Temboo_Inputs
{
   /**
    ...
    /**
     * Set the value for the ResponseFormat input for this GetCensusIDByCoordinates Choreo.
     *
...
class DataGov_GetCensusIDByTypeAndName_Inputs extends Temboo_Inputs
{
   /**
    ...
    /**
     * Set the value for the ResponseFormat input for this GetCensusIDByTypeAndName Choreo.
     *
     * @param string $value (optional, string) The format that the response should be in. Valid values are: xml (the default) and json.
     * @return DataGov_GetCensusIDByTypeAndName_Inputs For method chaining.
     */
...
class DataGov_GetDemographicsByCoordinates_Inputs extends Temboo_Inputs
{
   /**
     ...
     *
     * @param string $value (optional, string) Specify the data version to search. Valid values are 2011 or 2012 (the default).
     * @return DataGov_GetDemographicsByCoordinates_Inputs For method chaining.
     */
    ...
    /**
     * Set the value for the ResponseFormat input for this GetDemographicsByCoordinates Choreo.
     *
     * @param string $value (optional, string) The format that the response should be in. Valid values are: xml (the default) and json.
     * @return DataGov_GetDemographicsByCoordinates_Inputs For method chaining.
     */
...
class DataGov_GetDemographicsByTypeAndID_Inputs extends Temboo_Inputs
{
   /**
     ...
     *
     * @param string $value (optional, string) Specify the census data version to search. Valid values are: jun2011, dec2011, jun2012, and dec2012.
     * @return DataGov_GetDemographicsByTypeAndID_Inputs For method chaining.
     */
    public function setDataVersion($value)
    {
    ...
    /**
     * Set the value for the ResponseFormat input for this GetDemographicsByTypeAndID Choreo.
     *
     * @param string $value (optional, string) The format that the response should be in. Valid values are: xml (the default) and json.
     * @return DataGov_GetDemographicsByTypeAndID_Inputs For method chaining.
     */
...
class DataGov_GetDemographicsForNation_Inputs extends Temboo_Inputs
{
   /**
    ...
    /**
     * Set the value for the ResponseFormat input for this GetDemographicsForNation Choreo.
     *
     * @param string $value (optional, string) The format that the response should be in. Valid values are: xml (the default) and json.
     * @return DataGov_GetDemographicsForNation_Inputs For method chaining.
     */
