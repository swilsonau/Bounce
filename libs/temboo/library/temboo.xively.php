...
class Xively_ReadWriteData_WriteData_Inputs extends Temboo_Inputs
{
   /**
     ...
     *
     * @param mixed $value (optional, any) Custom data body for the new feed in JSON or XML format (set by FeedType).  See Xively documentation (link below) for the minimum required fields. If FeedData is used, Value and Timestamp are ignored.
     * @return Xively_ReadWriteData_WriteData_Inputs For method chaining.
     */
...
class Xively_ReadWriteData_WriteDatastreamMetadata_Inputs extends Temboo_Inputs
{
   /**
    ...
    /**
     * Set the value for the CurrentValue input for this WriteDatastreamMetadata Choreo.
     *
     * @param string $value (optional, string) The current value of the datastream. Leave empty to keep existing  CurrentValue. Type "BLANK" to clear existing value.
     * @return Xively_ReadWriteData_WriteDatastreamMetadata_Inputs For method chaining.
     */
     ...
     *
     * @param string $value (optional, json) Custom datastream formatted as a JSON array. See documentation for how to construct your own datastream feed. If custom DatastreamData is used, all other optional inputs are ignored.
     * @return Xively_ReadWriteData_WriteDatastreamMetadata_Inputs For method chaining.
     */
