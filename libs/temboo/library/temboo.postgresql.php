 ...
 * @subpackage PostgreSQL
 */
class PostgreSQL_ParameterizedQuery extends Temboo_Choreography
{
    /**
     * Allows you to run a parameterized query.
     *
     * @param Temboo_Session $session The session that owns this ParameterizedQuery Choreo.
     * @return PostgreSQL_ParameterizedQuery New instance.
     */
    public function __construct(Temboo_Session $session)
    {
        parent::__construct($session, '/Library/PostgreSQL/ParameterizedQuery/');
    }
     ...
     *
     * @param PostgreSQL_ParameterizedQuery_Inputs|array $inputs (optional) Inputs as PostgreSQL_ParameterizedQuery_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
     * @return PostgreSQL_ParameterizedQuery_Execution New execution object.
     * @throws Temboo_Exception_Authentication if session authentication fails.
     * @throws Temboo_Exception_Execution if runtime errors occur in synchronous execution or execution fails to start. NOT thrown for post-launch errors in asynchronous execution -- check status or results to determine asynchronous success.
     * @throws Temboo_Exception_Notfound if choreography does not exist.
     * @throws Temboo_Exception if execution request fails.
    ...
    public function execute($inputs = array(), $async = false, $store_results = true)
    {
        return new PostgreSQL_ParameterizedQuery_Execution($this->session, $this, $inputs, $async, $store_results);
    }
     ...
     *
     * @param array $inputs (optional) Associative array of input names and values.
     * @return PostgreSQL_ParameterizedQuery_Inputs New inputs object.
     * @throws Temboo_Exception if provided input set is invalid. (Note an empty set is considered valid.)
     */
    public function newInputs($inputs = array())
    {
        return new PostgreSQL_ParameterizedQuery_Inputs($inputs);
    }
}
 ...
 * @subpackage PostgreSQL
 */
class PostgreSQL_ParameterizedQuery_Inputs extends Temboo_Inputs
{
   /**
     * Inputs object with appropriate setters for the ParameterizedQuery Choreo.
     *
     * @param array $inputs (optional) Associative array of input names and values.
     * @return PostgreSQL_ParameterizedQuery_Inputs New instance.
     * @throws Temboo_Exception if provided input set is invalid. (Note an empty set is considered valid.)
     */
    public function __construct($inputs = array())
    {
     ...
     * @param string $name Input name.
     * @param string $value Input value.
     * @return PostgreSQL_ParameterizedQuery_Inputs For method chaining.
     */
    public function set($name, $value)
    {
        return parent::set($name, $value);
    ...
    /**
     * Set the value for the Version input for this ParameterizedQuery Choreo.
     *
     * @param int $value (optional, integer) The version of the Postgres database. Allowed values are 8 and 9 (the default).
     * @return PostgreSQL_ParameterizedQuery_Inputs For method chaining.
     */
    public function setVersion($value)
    {
 ...
 * @subpackage PostgreSQL
 */
class PostgreSQL_ParameterizedQuery_Execution extends Temboo_Choreography_Execution
{
    /**
     * Execution object for the ParameterizedQuery Choreo.
     *
     * @param Temboo_Session $session The session that owns this ParameterizedQuery execution.
     * @param PostgreSQL_ParameterizedQuery $choreo The choreography object for this execution.
     * @param PostgreSQL_ParameterizedQuery_Inputs|array $inputs (optional) Inputs as PostgreSQL_ParameterizedQuery_Inputs or associative array.
     * @param bool $async Whether to execute in asynchronous mode. Default false.
     * @param bool $store_results Whether to store results of asynchronous execution. Default true.
     * @return PostgreSQL_ParameterizedQuery_Execution New execution.
     * @throws Temboo_Exception_Authentication if session authentication fails.
     * @throws Temboo_Exception_Execution if runtime errors occur in synchronous execution or execution fails to start. NOT thrown for post-launch errors in asynchronous execution -- check status or results to determine asynchronous success.
     * @throws Temboo_Exception_Notfound if choreography does not exist.
     */
    public function __construct(Temboo_Session $session, PostgreSQL_ParameterizedQuery $choreo, $inputs = array(), $async = false, $store_results = true)
    {
        parent::__construct($session, $choreo, $inputs, $async, $store_results);
    }
     ...
     *
     * @return PostgreSQL_ParameterizedQuery_Results New results object.
     * @throws Temboo_Exception_Authentication if session authentication fails.
     * @throws Temboo_Exception_Execution if runtime errors occurred in asynchronous execution.
     * @throws Temboo_Exception_Notfound if execution does not exist.
     * @throws Temboo_Exception if result request fails.
    ...
    protected function wrapResults($outputs)
    {
        return new PostgreSQL_ParameterizedQuery_Results($outputs);
    }
}
 ...
 * @subpackage PostgreSQL
 */
class PostgreSQL_ParameterizedQuery_Results extends Temboo_Results
{
    /**
     * Results object with appropriate getters for the ParameterizedQuery Choreo.
     *
     * @param array $outputs (optional) Associative array of output names and values.
     * @return PostgreSQL_ParameterizedQuery_Results New instance.
     * @throws Temboo_Exception if provided output set is invalid. (Note an empty set is considered valid.)
     */
    public function __construct($outputs = array())
    {
