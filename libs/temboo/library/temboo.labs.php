...
class Labs_GoodCitizen_Civic_Inputs extends Temboo_Inputs
{
   /**
     ...
     *
     * @param string $value (conditional, json) A JSON dictionary containing credentials for Sunlight Labs and LittleSis. If this input is set, a Sunset Labs key must be present. See Choreo notes for formatting examples.
     * @return Labs_GoodCitizen_Civic_Inputs For method chaining.
     */
    public function setAPICredentials($value)
    {
